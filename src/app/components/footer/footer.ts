      ...
      <div class="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div class="flex items-center gap-3">
          <span class="text-lg font-bold">
            <span class="text-indigo-500">Dev</span><span class="text-white">Freelance</span>
          </span>
        ...
        <div class="flex items-center gap-6">
          ...
          <a
            routerLink="/admin"
            class="text-gray-700 hover:text-gray-400 transition-colors focus-visible:outline-2 focus-visible:outline-indigo-500 rounded opacity-40 hover:opacity-100"
